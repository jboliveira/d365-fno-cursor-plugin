...
The xpp-fno plugin does **not** bundle MCP servers. Agents reference **microsoft-learn** when official Microsoft F&O documentation is needed.

## Setup

1. Copy [`mcp.template.json`](../mcp.template.json) to your Cursor user MCP config, or
2. Enable **Microsoft Learn MCP** in Cursor **Settings → MCP** as `microsoft-learn`.
